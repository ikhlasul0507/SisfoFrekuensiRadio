                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#home1" role="tab">User Registrasi</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#profile1" role="tab">Profil User registrasi</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#messages1" role="tab">Registrasi Akun</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#settings1" role="tab">Profil Perusahaan</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3" id="home1" role="tabpanel">
                                            ...
                                            <br>
                                             <input type="checkbox" id="switch6" name="konfirmasi" class="form-control" switch="primary" required />
                                        ...
                                        <div class="tab-pane p-3" id="profile1" role="tabpanel">
                                            <fieldset class="form-group floating-label-form-group">
                                               ...
                                               <input type="text" name="pic_name" required class="form-control  round" >
                                           </fieldset>
                                           <fieldset class="form-group floating-label-form-group">
                                               <label for="email">Jabatan</label>
                                               <input type="text" name="pic_jabatan" class="form-control  round" >
                                           </fieldset>
                                           <fieldset class="form-group floating-label-form-group">
                                               <label for="email">Email</label>
                                               <input type="email" name="pic_email" required class="form-control  round" >
                                           </fieldset>   
                                        </div>
                                        <div class="tab-pane p-3" id="messages1" role="tabpanel">
                                           ...
                                           <fieldset class="form-group floating-label-form-group">
                                               ...
                                               <input type="password" name="password" required class="form-control  round" >
                                           </fieldset>
                                        </div>
                                        <div class="tab-pane p-3" id="settings1" role="tabpanel">
                                           <fieldset class="form-group floating-label-form-group">
                                               <label for="email">Nama Perusahaan</label>
                                               <input type="text" name="nm_pt" required class="form-control  round" >
                                           </fieldset>
                                           <fieldset class="form-group floating-label-form-group">
                                               <label for="email">Telepon</label>
                                               <input type="text" name="telp" required class="form-control  round" >
                                           </fieldset>
                                           <fieldset class="form-group floating-label-form-group">
                                    ...
                                    <button class="btn btn-primary w-md waves-effect waves-light col-12" type="submit">Register User</button>
