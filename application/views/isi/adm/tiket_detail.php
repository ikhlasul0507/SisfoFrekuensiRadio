...
<div class="content-page">
  ...
  <div class="content">
        ...
        <div class="card m-b-20">
          ...
          <div class="tab-content">
            <div class="tab-pane active p-3" id="home1" role="tabpanel">
              ...
              <br>
              <form action="<?php echo site_url('adm/tiket/verify'); ?>" method="post" enctype="multipart/form-data">
               <input type="hidden" name="id_tiket" value="<?=$tiket->id_tiket;?>">
               <input type="hidden" name="id_pt" value="<?=$tiket->id_pt;?>">

               <fieldset class="form-group floating-label-form-group">
                <label for="email">Hasil Verifikasi</label>
                <select name="status" id="select" required class="custom-select">

                  <option value=""></option>

                  <?php if($tiket->status == "New"){ ?>

                    <option value="New">Not Verified</option>
                    <option value="Verified">Verified</option>

                  <?php }else if($tiket->status=="Verified"){ ?>

                    <option value="Closed">Close With Solusi</option>
                    <option value="Resolved">Close Without Solusi</option>

                  <?php } ?>
                </select>
              </fieldset>

              <?php if($tiket->status=="Verified"){?>
                <fieldset class="form-group floating-label-form-group">
                  <label for="email">Lampiran Hasil Solusi *pdf</label><br>
                  <input type="file" name="file_solusi" class="form-control">
                </fieldset>
    ...
    <p align="right">
      ...
      <button type="submit" <?=$isDissable;?> class="btn btn-primary col-3">
        <i class="fas fa-save "></i> &nbsp; Kirim dan Simpan Tiket
      </button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php if ($tiket->file_surat == "default.png") { ?>
          <center>
            <img src="<?php echo base_url('assets/images/surat/'.$tiket->file_surat) ?>" height="500" height="750"><br>Tidak ada file yang dilampirkan</center>
          <?php }else{ ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <?php if ($tiket->file_lampiran == "default.png") { ?>
            <center>
              <img src="<?php echo base_url('assets/images/surat/'.$tiket->file_lampiran) ?>" height="500" height="750"><br>Tidak ada file yang dilampirkan</center>
            <?php }else{ ?>
