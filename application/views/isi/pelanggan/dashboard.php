                                        ...
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                ...
                                                <div class="text-white">
                                                    ...
                                                    <?php $array = array('status' => 'New', 'id_pt'=> $this->session->userdata('id_user'));
  echo $totalNew = $this->db->where($array)->count_all_results('tiket'); ?> Tiket Baru</b></h4>

  <?php $array5 = array('status' => 'Verified', 'id_pt'=> $this->session->userdata('id_user'));
  $totalVerified = $this->db->where($array5)->count_all_results('tiket'); ?>
                                        ...
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                ...
                                                <div class="text-white">
                                                    <h6 class="mt-0 text-white-50"><a href='' class="text-white">Total</a></h6>
                                                    <h4 class="mb-3 mt-0"><b> 
                                                    <?php $array = array('status' => 'Verified', 'id_pt'=> $this->session->userdata('id_user'));
  echo $total1 = $this->db->where($array)->count_all_results('tiket'); ?> Tiket Verified</b></h4>
                                        ...
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                ...
                                                <div class="text-white">
                                                    <h6 class="mt-0 text-white-50"><a href="" class="text-white">Total</a></h6>
                                                    <h4 class="mb-3 mt-0"><b>
                                                    <?php $array = array('status' => 'Closed', 'id_pt'=> $this->session->userdata('id_user'));
                                                    $array2 = array('status' => 'Resolved', 'id_pt'=> $this->session->userdata('id_user'));
