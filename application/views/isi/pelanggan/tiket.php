      ...
      <div class="card-body">
        ...
        <form action="<?php echo site_url('pelanggan/tiket/add'); ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
           <div class="col-lg-6 col-md-6 col-6">
            <fieldset class="form-group floating-label-form-group">
              ...
              <select  name ="id_kabupaten" id="id_kabupaten" onchange="getKecamatan()" required class="custom-select">
          ...
          <div class="col-lg-6 col-md-6 col-6">
            <fieldset class="form-group floating-label-form-group">
              ...
              <select name="id_kecamatan" id="id_kecamatan" required class="custom-select">
        ...
        <a data-toggle="modal" data-target="#bb">
          <button type="button" class="btn btn-primary w-md waves-effect waves-light col-12">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <fieldset class="form-group floating-label-form-group">
                      ...
                      <input type="date" name="tgl_gangguan" value="<?= date("Y-m-d"); ?>" class="form-control  round" required id="email">
                    </fieldset>
            ...
            <fieldset class="form-group floating-label-form-group">
              <label for="email">Tambahan Lampiran *pdf</label><br>
