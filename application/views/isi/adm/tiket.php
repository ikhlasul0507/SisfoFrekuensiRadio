      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="page-title-box">
            <h3 class="page-title"><b><i class="fas fa-folder-open"></i>&nbsp; Daftar Tiket Masuk</b></h3>
            <ol class="breadcrumb">
                         ...
                         <div class="col-lg-12">
                                    <div class="card m-b-30">
                                        <div class="card-header bg-primary">
                                            <span class="badge badge-light"><?=$tiket->status;?></span> <font color="white"><?=$tiket->perihal?></font>
                                        </div>
                                        <div class="card-body">
