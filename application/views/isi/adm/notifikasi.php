...
?>
                ...
                <?php
                 ...
                 <a href="<?php echo base_url().'adm/tiket/detail/'.$n->id_tiket.'/'.$n->id_notif?>" class="text-reset notification-item">
              ...
              <div class="alert alert-<?=$color;?>" role="alert">
                                ...
                                <i class='far fa-building '></i>&nbsp; <?=$n->nm_pt;?> &nbsp; <i class='fas fa-user'></i>&nbsp; <?=$n->pic_name;?> <br>
